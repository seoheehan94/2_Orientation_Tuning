...
prffolder_photoSP = '/bwdata/NSDData/Seohee/Orientation/prfsample/';
prffolder_ldSP = '/bwdata/NSDData/Seohee/Orientation/prfsample_Ori_control/';
prffolder_contour = '/bwdata/NSDData/Seohee/Orientation/prfsample_Ori/';
...
for condition = 1:3 %1=photoSP, 2=ldSP, 3=contour
    for isub=1:length(subjects)
        ...
        load([folder_list{condition} 'voxModelPref_regress_sub' num2str(isub) '.mat'],'allRoiPrf',...
