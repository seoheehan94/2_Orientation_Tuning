...
% DOI:
%
%   usage: getVoxPref(1,1,1)
%   by: zvi roth
%   date: 7/29/2022
%   purpose: extract preferred orientation from regression weights for each
%   voxel
%   uses files created by: regressPrfSplit.m
%   creates files used by: fig$$.m


function getVoxPref(isub,numregions, con)
...
for iregion=1:numregions
    ...
    load(fullfile(curPrf, ['regressPrfSplit' bandpassStr '_v' num2str(visualRegion) '_sub' num2str(isub)  '.mat']), ...
        'nsd','numLevels', 'numOrientations','rois','nvox','roiPrf','nsplits');
...
save([curPrf 'voxModelPref_sub' num2str(isub) '.mat'],'allRoiPrf',...
    'roiOri','roiNsdOriCorr', 'roiNsdOriR2', 'allaicOriSplit', 'allbicOriSplit',...
