...
%% Add path
original_folder = '/bwlab/Users/SeoheeHan/NSDData/rothzn/nsd/stimuli/pyramid_LD'; % Original image file folder
addpath(original_folder);

save_folder = '/bwlab/Users/SeoheeHan/NSDData/rothzn/nsd/Orientation/ori_hist/LD';
...
save(fullfile(save_folder, 'LD.mat'), 'modelOriSum');
